...
//   var istep = 1 - step;
//   var r = Math.round(istep * c0[0] + step * c1[0]);
//   var g = Math.round(istep * c0[1] + step * c1[1]);
//   var b = Math.round(istep * c0[2] + step * c1[2]);
//   var color = "rgb(" + r + "," + g + "," + b + ")";
